...
class InitialBinding implements Bindings{
  @override
  void dependencies() {
    Get.lazyPut<GetLocalStorage>(() => GetLocalStorageImpl());
    Get.lazyPut<SplashController>(() =>SplashController());
    Get.put<AccountInfoStorage>(AccountInfoStorage(Get.find<GetLocalStorage>()),permanent: true);
    Get.put<ChangeThemeController>(ChangeThemeController(Get.find<GetLocalStorage>()),permanent: true);
